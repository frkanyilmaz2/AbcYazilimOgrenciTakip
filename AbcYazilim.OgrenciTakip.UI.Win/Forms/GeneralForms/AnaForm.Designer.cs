namespace AbcYazilim.OgrenciTakip.UI.Win.Forms.GeneralForms
{
    partial class AnaForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ribbonPage1});
            this.ribbonControl.Size = new System.Drawing.Size(1206, 158);
            ...
            // btnIsYeriKartlari
            // 
            this.btnIsYeriKartlari.Caption = "İş Yeri Kartları";
            ...
            // ribbonPageGroup
            // 
            this.ribbonPageGroup.ItemLinks.Add(this.btnOkulKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnIlKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnAileBilgiKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnIptalNedeniKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnYabanciDilKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnTesvikKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnKontenjanKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnRehberKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnSinifGrupKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnMeslekKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnYakinlikKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnIsYeriKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnGorevKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnIndirimTuruKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnEvrakKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnPromosyonKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnServisYeriKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnSinifKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnHizmetTuruKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnHizmetKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnKasaKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnBankaKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnAvukatKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnCariKartlar);
            this.ribbonPageGroup.ItemLinks.Add(this.btnOdemeTuruKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnBankaHesapKartlari);
            this.ribbonPageGroup.ItemLinks.Add(this.btnIletisimKartlari);
            ...
            this.ribbonStatusBar.Size = new System.Drawing.Size(1206, 24);
            // 
